...
declare type FormRule<Value, Values> = NonNullable<Value> extends Array<infer ListValue> ? Partial<{
...
}> | Rule<Value, Values> : NonNullable<Value> extends Record<string, unknown> ? FormRulesRecord<Value> | Rule<Value, Values> : Rule<Value, Values>;
...
export declare type ClearFieldDirty = (path: unknown) => void;
